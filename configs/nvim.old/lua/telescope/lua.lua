...
-- mappings
vim.api.nvim_set_keymap("n", "<Leader>ff", [[<Cmd>lua require('telescope.builtin').find_files({previewer = false})<CR>]], opt)
vim.api.nvim_set_keymap("n", "<Leader>a", [[<Cmd>lua require('telescope.builtin').lsp_code_actions()<CR>]], opt)
...
vim.api.nvim_set_keymap("n", "<Leader>fh", [[<Cmd>lua require('telescope.builtin').live_grep()<CR>]], opt)
vim.api.nvim_set_keymap("n", "<Leader>fg", [[<Cmd>lua require('telescope.builtin').git_status()<CR>]], opt)
vim.api.nvim_set_keymap("n", "<Leader>fb", [[<Cmd>lua require('telescope.builtin').git_branches()<CR>]], opt)
