...
map("n", "<leader>ls", ":Lazy load leetcode.nvim<CR>:Leet<CR>", { desc = "Start Leet" })
map("n", "<leader>ll", ":Leet lang<CR>", { desc = "Leet lang" })
map("n", "<leader>lo", ":Leet list<CR>", { desc = "Leet list" })
map("n", "<leader>lm", ":Leet menu<CR>", { desc = "Leet menu" })
map("n", "<leader>ld", ":Leet desc<CR>", { desc = "Leet description" })
map("n", "<leader>lr", ":Leet run<CR>", { desc = "Leet run" })
map("n", "<leader>li", ":Leet info<CR>", { desc = "Leet info" })
map("n", "<leader>lb", ":Leet tabs<CR>", { desc = "Leet tabs" })
map("n", "<leader>lp", ":Leet last_submit<CR>", { desc = "Leet last_submit" })
map("n", "<leader>lw", ":Leet submit<CR>", { desc = "Leet submit" })
